          ...
          <div class="filter-bar d-flex flex-wrap align-items-center">
            ...
            <div>
              <div class="input-group filter-bar-search">
                <input class="ti-search" type="text" id="search-user" placeholder="Rechercher">
            ...
            <div id="result-search" class="row">
              ...
              <div class="col-md-6 col-lg-4">
                <div class="card text-center card-product">
                  ...
                  <div class="card-body">
                    <p><?=$produit["NOMcat"]?></p>
                    <h4 class="card-product__title"><a  href="single-product.php?ID=<?= $produit['ID']?>" ><?=$produit["Nom"] ;?></a></h4>
          ...
          $(document).ready(function(){
              ...
              $('#result-search').html('');
                  ...
                  if( produit!="")
                  {
                    $.ajax({
                      type:'GET',
                      url: 'fonctions/search_prod.php',
                      data: 'user='+ encodeURIComponent(produit),
                      dataType: "text", 
